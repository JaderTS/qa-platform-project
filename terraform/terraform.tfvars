...
instance_type    = "t3.small"       # temporarily upsized for initial provisioning; scale back to t3.micro after the stack is up
key_name         = "qa-project-key" # set to an existing EC2 key pair name before applying
